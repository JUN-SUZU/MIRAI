...
CREATE TABLE linked_accounts (
    base_user_id    TEXT REFERENCES users(discord_id) ON DELETE CASCADE,
    linked_user_id  TEXT REFERENCES users(discord_id) ON DELETE CASCADE,
...
CREATE TABLE guilds (
    ...
    owner_id        TEXT REFERENCES users(discord_id),
    lang            TEXT,
    country         TEXT,
    channel_id      TEXT,
    role_id         TEXT,
    ...
    vpn_check       BOOLEAN,
    robot_check     BOOLEAN,
    spam_protection_level INTEGER, -- 0:無効 1:低 2:中 3:高 4:最高
